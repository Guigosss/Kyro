package com.bulk.kyro.initializers;
...
import com.bulk.kyro.repositories.MuscleGroupRepository;
...
public class Seed implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        UserEntity admin = new UserEntity("Guigos", password, UserRole.ADMIN);
        UserEntity user = new UserEntity("Guigui", password, UserRole.USER);
